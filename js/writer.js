...
/* Return a random color for the lyric boxes */
...
$(document).ready(function() {
	...
	/* Determines the content of the top bar based on whether you're logged in or not*/
	...
	/* Logs the user in and shows a notification on whether the login succeeded or not*/
	...
	$(document).on("click", ".submitbutton", pushData);

	/* Defines on whether the login button goes to the mobile login or the desktop login based on the media query */
